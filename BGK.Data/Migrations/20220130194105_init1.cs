...
namespace BearGoodbyeKolkhozProject.Data.Migrations
{
    public partial class init1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Lecturer",
                columns: new[] { "Id", "BirthDay", "Gender", "IsDeleted", "LastName", "Name" },
                values: new object[,]
                {
                    { 1, "27 августа", 1, false, "Пототько", "Вячеслав Ибрагимович" },
                    { 2, "22 сентября", 2, false, "Цыплухина", "Евгения Владимировна" },
                    { 3, "15 октября", 1, false, "Вейпов", "Андрей Андреевич" }
                });
